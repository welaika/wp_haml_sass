                ...
                <li class="attachments-file">
                  <h2>
                    <a href="#" class="attachment-handle">
                      <span class="attachment-handle-icon"><img src="<?php echo get_bloginfo('template_directory').'/lib/vendor'; ?>/attachments/images/handle.gif" alt="Drag" /></span>
                    </a>
...
function attachments_init_js()
{
  ...
  echo '  var attachments_base = "' . get_bloginfo('template_directory') . '/lib/vendor/attachments"; ';
...
function attachments_init()
{
  ...
  wp_enqueue_style( 'attachments', get_bloginfo('template_directory').'/lib/vendor/attachments/css/attachments.css' );
  wp_enqueue_script( 'attachments', get_bloginfo('template_directory').'/lib/vendor/attachments/js/attachments.js', array( 'thickbox' ), false, false );
