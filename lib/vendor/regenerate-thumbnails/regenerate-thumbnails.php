...
class RegenerateThumbnails {
  ...
  function admin_enqueues( $hook_suffix ) {
    ...
    wp_enqueue_script( 'jquery-ui-progressbar', get_bloginfo('template_directory').'/lib/vendor/regenerate-thumbnails/jquery-ui/ui.progressbar.js', array('jquery-ui-core'), '1.7.2' );
    wp_enqueue_style( 'jquery-ui-regenthumbs', get_bloginfo('template_directory').'/lib/vendor/regenerate-thumbnails/jquery-ui/redmond/jquery-ui-1.7.2.custom.css', array(), '1.7.2' );
  }
